...
/***/ "./src/app/main/content/apps/e-commerce/components/inventory-list/inventory-list.component.html":
/***/ (function(module, exports) {

module.exports = "<mat-table #table [dataSource]=\"dataSource\" matSort\n           [@animateStagger]=\"{value:'50'}\">\n    \n    <ng-container cdkColumnDef=\"sku\">\n      <mat-header-cell *cdkHeaderCellDef mat-sort-header>Sku</mat-header-cell>\n      <mat-cell *cdkCellDef=\"let item\">\n        <p class=\"text-truncate\">{{ item.sku }}</p>\n      </mat-cell>\n    </ng-container>\n\n    <ng-container cdkColumnDef=\"size\">\n      <mat-header-cell *cdkHeaderCellDef mat-sort-header>Size</mat-header-cell>\n      <mat-cell *cdkCellDef=\"let item\">\n        <p class=\"text-truncate\">{{ item.size }}</p>\n      </mat-cell>\n    </ng-container>\n\n    <ng-container cdkColumnDef=\"color\">\n      <mat-header-cell *cdkHeaderCellDef mat-sort-header>Color</mat-header-cell>\n      <mat-cell *cdkCellDef=\"let item\">\n        <p class=\"text-truncate\">{{ item.color }}</p>\n      </mat-cell>\n    </ng-container>\n\n    <ng-container cdkColumnDef=\"site\">\n      <mat-header-cell *cdkHeaderCellDef mat-sort-header>Site</mat-header-cell>\n      <mat-cell *cdkCellDef=\"let item\">\n        <p class=\"text-truncate\">{{ item.site }}</p>\n      </mat-cell>\n    </ng-container>\n\n    <ng-container cdkColumnDef=\"bin\">\n      <mat-header-cell *cdkHeaderCellDef mat-sort-header>Bin</mat-header-cell>\n      <mat-cell *cdkCellDef=\"let item\">\n        <p class=\"text-truncate\">{{ item.bin }}</p>\n      </mat-cell>\n    </ng-container>\n\n    <ng-container cdkColumnDef=\"quantity\">\n      <mat-header-cell *cdkHeaderCellDef mat-sort-header>Quantity</mat-header-cell>\n      <mat-cell *cdkCellDef=\"let item\">\n        <p class=\"text-truncate\">{{ item.quantity }}</p>\n      </mat-cell>\n    </ng-container>\n\n    <ng-container cdkColumnDef=\"lastInsertDate\">\n      <mat-header-cell *cdkHeaderCellDef mat-sort-header>Last Insert Date</mat-header-cell>\n      <mat-cell *cdkCellDef=\"let item\">\n        <p class=\"text-truncate\">{{ item.lastInsertDate | date }}</p>\n      </mat-cell>\n    </ng-container>\n\n    <mat-header-row *cdkHeaderRowDef=\"displayedColumns\"></mat-header-row>\n    <mat-row *cdkRowDef=\"let item; columns: displayedColumns;\"\n             class=\"inventory-item\"\n             matRipple\n             [@animate]=\"{value:'*',params:{y:'100%'}}\">\n    </mat-row>\n</mat-table>\n\n<mat-paginator #paginator\n               [pageSize]=\"10\"\n               [pageSizeOptions]=\"[5, 10, 20]\"\n               [showFirstLastButtons]=\"true\">\n</mat-paginator>"

/***/ }),

/***/ "./src/app/main/content/apps/e-commerce/components/inventory-list/inventory-list.component.scss":
/***/ (function(module, exports) {

module.exports = "app-inventory-list {\n  -webkit-box-flex: 1;\n      -ms-flex: 1;\n          flex: 1;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column; }\n  app-inventory-list .mat-table {\n    -webkit-box-flex: 1;\n        -ms-flex: 1;\n            flex: 1; }\n  app-inventory-list .mat-sort-header-arrow.ng-trigger.ng-trigger-arrowPosition {\n    opacity: 0; }\n  app-inventory-list .mat-sort-header-pointer-left.ng-trigger.ng-trigger-leftPointer {\n    -webkit-transform: rotate(-45deg);\n            transform: rotate(-45deg); }\n  app-inventory-list .mat-sort-header-pointer-right.ng-trigger.ng-trigger-rightPointer {\n    -webkit-transform: rotate(45deg);\n            transform: rotate(45deg); }\n"

/***/ }),

/***/ "./src/app/main/content/apps/e-commerce/components/inventory-list/inventory-list.component.ts":
...
var InventoryListComponent = /** @class */ (function () {
    function InventoryListComponent() {
        this.data = [];
        this.displayedColumns = ['sku', 'size', 'color', 'site', 'bin', 'quantity', 'lastInsertDate'];
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["S" /* MatTableDataSource */]([]);
    }
    InventoryListComponent.prototype.ngOnChanges = function (changes) {
        if (changes.data) {
    ...
    ], InventoryListComponent.prototype, "data", void 0);
    __decorate([
    ...
    InventoryListComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/main/content/apps/e-commerce/components/inventory-list/inventory-list.component.html"),
            styles: [__webpack_require__("./src/app/main/content/apps/e-commerce/components/inventory-list/inventory-list.component.scss")],
...
/***/ "./src/app/main/content/apps/e-commerce/components/product-prices/product-prices.component.html":
/***/ (function(module, exports) {

module.exports = "<form fxLayout=\"column\" [formGroup]=\"pricesForm\">\n  <div fxLayout=\"row\" class=\"p-16\">\n    <mat-form-field fxFlex class=\"mr-20 mw-240\">\n        <input\n          matInput\n          placeholder=\"Name\"\n          formControlName=\"name\"\n        />\n    </mat-form-field>\n    \n    <mat-form-field fxFlex class=\"mr-20 mw-240\">\n      <input\n        matInput\n        placeholder=\"Value\"\n        formControlName=\"value\"\n      />\n    </mat-form-field>\n\n    <mat-form-field fxFlex class=\"mw-240\">\n      <input\n        matInput\n        placeholder=\"PrCode\"\n        formControlName=\"prCode\"\n      />\n    </mat-form-field>\n  </div>\n\n  <div fxLayout=\"row\" class=\"p-16 pt-0\">\n    <div fxFlex=\"none\"\n         class=\"w-144 mr-16\">\n      <div class=\"prb-label\">Qty</div>\n      <div class=\"prb-label\">Sales Price</div>\n      <div class=\"prb-label\">Pr Code</div>\n      <div class=\"prb-label\">Margin</div>\n      <div class=\"prb-label\">Unit Cost</div>\n      <div class=\"prb-label\">Unit Profit</div>\n      <div class=\"prb-label mt-16\">Total Sales Price</div>\n      <div class=\"prb-label\">Total Cost</div>\n      <div class=\"prb-label\">Total Profit</div>\n    </div>\n\n    <div fxFlex\n         formArrayName=\"priceBreaks\"\n         fusePerfectScrollbar>\n      <div fxFlex=\"none\"\n           class=\"prb-column w-144 mr-16\"\n           [formGroupName]=\"i\"\n           *ngFor=\"let prb of pricesForm.get('priceBreaks').controls; let i = index;\">\n        <mat-form-field>\n          <input matInput\n                 type=\"number\"\n                 formControlName=\"qty\"\n                 (change)=\"updateQty($event, i)\"/>\n        </mat-form-field>\n\n        <mat-form-field>\n          <input matInput\n                 type=\"number\"\n                 formControlName=\"salesPrice\"\n                 (change)=\"updateSalesPrice($event, i)\"/>\n        </mat-form-field>\n\n        <div class=\"prb-label\">{{ data.prCode }}&nbsp;</div>\n\n        <mat-form-field>\n          <input matInput\n                 type=\"number\"\n                 formControlName=\"margin\"\n                 (change)=\"updateMargin($event, i)\"/>\n        </mat-form-field>\n\n        <mat-form-field>\n          <input matInput\n                 type=\"number\"\n                 formControlName=\"unitCost\"\n                 (change)=\"updateUnitCost($event, i)\"/>\n        </mat-form-field>\n\n        <mat-form-field>\n          <input matInput\n                 type=\"number\"\n                 formControlName=\"unitProfit\"\n                 (change)=\"updateUnitProfit($event, i)\"/>\n        </mat-form-field>\n\n        <div class=\"prb-label mt-16\">{{ getTotalSalesPrice(i) | number:'.2-2' }}</div>\n\n        <div class=\"prb-label\">{{ getTotalCost(i) | number:'.2-2' }}</div>\n\n        <div class=\"prb-label\">{{ getTotalProfit(i) | number:'.2-2' }}</div>\n      </div>\n\n      <div fxFlex=\"none\" class=\"prb-column w-144\">\n        <button mat-button fxFlex\n                (click)=\"addNewPbrForm()\">\n          <mat-icon>add</mat-icon>\n        </button>\n      </div>\n    </div>\n  </div>\n</form>\n"

/***/ }),

/***/ "./src/app/main/content/apps/e-commerce/components/product-prices/product-prices.component.scss":
/***/ (function(module, exports) {

module.exports = "app-product-prices {\n  -webkit-box-flex: 1;\n      -ms-flex: 1;\n          flex: 1; }\n  app-product-prices form {\n    color: #333; }\n  app-product-prices form .mat-form-field-infix {\n      width: 144px; }\n  app-product-prices form .mat-form-field-wrapper {\n      margin-bottom: -1.25em; }\n  app-product-prices form .prb-label {\n      font-weight: 400;\n      font-size: 16px;\n      font-family: Roboto, \"Helvetica Neue\", sans-serif;\n      line-height: 1.125;\n      padding: 0.4375em 0;\n      border-top: 0.84375em solid transparent;\n      border-bottom: 1px solid transparent; }\n  app-product-prices form .prb-column .prb-label {\n      color: #666;\n      font-weight: 600; }\n  app-product-prices form .prb-column .mat-button .mat-icon {\n      height: 72px;\n      width: 72px;\n      font-size: 72px; }\n  app-product-prices .mw-240 {\n    max-width: 240px; }\n"

/***/ }),

/***/ "./src/app/main/content/apps/e-commerce/components/product-prices/product-prices.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProductPricesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__("./src/app/main/content/apps/e-commerce/models.ts");
...
var ProductPricesComponent = /** @class */ (function () {
    function ProductPricesComponent(fb) {
        this.fb = fb;
        this.data = new __WEBPACK_IMPORTED_MODULE_2__models__["b" /* PriceOption */]();
        this.priceBreaks = [];
    }
    ProductPricesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.priceBreaks = this.data.priceBreaks.map(function (prb) { return new __WEBPACK_IMPORTED_MODULE_2__models__["a" /* PriceBreak */](prb); });
        var priceBreakForms = this.data.priceBreaks.map(function (prb) {
            return _this.fb.group(__assign({}, prb));
        });
        this.pricesForm = this.fb.group({
            name: [this.data.name],
            value: [this.data.value],
            prCode: [this.data.prCode],
            priceBreaks: this.fb.array(priceBreakForms)
        });
    };
    ProductPricesComponent.prototype.addNewPbrForm = function () {
        var prbForms = this.pricesForm.controls['priceBreaks'];
        var prb = new __WEBPACK_IMPORTED_MODULE_2__models__["a" /* PriceBreak */]();
        prbForms.push(this.fb.group(prb));
        this.priceBreaks.push(prb);
    };
    ProductPricesComponent.prototype.updateQty = function (ev, i) {
        this.priceBreaks[i].qty = ev.target.value;
    };
    ProductPricesComponent.prototype.updateSalesPrice = function (ev, i) {
        this.priceBreaks[i].updateSalesPrice(ev.target.value);
        this.updatePbrFormValues(i);
    };
    ProductPricesComponent.prototype.updateMargin = function (ev, i) {
        this.priceBreaks[i].updateMargin(ev.target.value);
        this.updatePbrFormValues(i);
    };
    ProductPricesComponent.prototype.updateUnitCost = function (ev, i) {
        this.priceBreaks[i].updateUnitCost(ev.target.value);
        this.updatePbrFormValues(i);
    };
    ProductPricesComponent.prototype.updateUnitProfit = function (ev, i) {
        this.priceBreaks[i].updateProfit(ev.target.value);
        this.updatePbrFormValues(i);
    };
    ProductPricesComponent.prototype.updatePbrFormValues = function (i) {
        var prbForms = this.pricesForm.controls['priceBreaks'];
        prbForms.at(i).setValue(this.priceBreaks[i]);
    };
    ProductPricesComponent.prototype.getTotalSalesPrice = function (i) {
        return this.priceBreaks[i].totalSalesPrice;
    };
    ProductPricesComponent.prototype.getTotalCost = function (i) {
        return this.priceBreaks[i].totalCost;
    };
    ProductPricesComponent.prototype.getTotalProfit = function (i) {
        return this.priceBreaks[i].totalProfit;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__models__["b" /* PriceOption */])
    ], ProductPricesComponent.prototype, "data", void 0);
    ProductPricesComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-product-prices',
            template: __webpack_require__("./src/app/main/content/apps/e-commerce/components/product-prices/product-prices.component.html"),
            styles: [__webpack_require__("./src/app/main/content/apps/e-commerce/components/product-prices/product-prices.component.scss")],
            encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__dashboard_dashboard_component__ = __webpack_require__("./src/app/main/content/apps/e-commerce/dashboard/dashboard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__dashboard_dashboard_service__ = __webpack_require__("./src/app/main/content/apps/e-commerce/dashboard/dashboard.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__products_products_component__ = __webpack_require__("./src/app/main/content/apps/e-commerce/products/products.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__products_products_service__ = __webpack_require__("./src/app/main/content/apps/e-commerce/products/products.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__product_product_component__ = __webpack_require__("./src/app/main/content/apps/e-commerce/product/product.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__product_product_service__ = __webpack_require__("./src/app/main/content/apps/e-commerce/product/product.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__orders_orders_component__ = __webpack_require__("./src/app/main/content/apps/e-commerce/orders/orders.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__orders_orders_service__ = __webpack_require__("./src/app/main/content/apps/e-commerce/orders/orders.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__order_order_component__ = __webpack_require__("./src/app/main/content/apps/e-commerce/order/order.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__order_order_service__ = __webpack_require__("./src/app/main/content/apps/e-commerce/order/order.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_product_prices_product_prices_component__ = __webpack_require__("./src/app/main/content/apps/e-commerce/components/product-prices/product-prices.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_inventory_list_inventory_list_component__ = __webpack_require__("./src/app/main/content/apps/e-commerce/components/inventory-list/inventory-list.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'dashboard',
        component: __WEBPACK_IMPORTED_MODULE_9__dashboard_dashboard_component__["a" /* FuseEcommerceDashboardComponent */],
        resolve: {
            data: __WEBPACK_IMPORTED_MODULE_10__dashboard_dashboard_service__["a" /* EcommerceDashboardService */]
        }
    },
    {
        path: 'products',
        component: __WEBPACK_IMPORTED_MODULE_11__products_products_component__["a" /* FuseEcommerceProductsComponent */],
        resolve: {
            data: __WEBPACK_IMPORTED_MODULE_12__products_products_service__["a" /* EcommerceProductsService */]
        }
    },
    {
        path: 'products1',
    ...
    {
        path: 'products/:id',
        component: __WEBPACK_IMPORTED_MODULE_13__product_product_component__["a" /* FuseEcommerceProductComponent */],
        resolve: {
            data: __WEBPACK_IMPORTED_MODULE_14__product_product_service__["a" /* EcommerceProductService */]
        }
    },
    {
    ...
    {
        path: 'orders',
        component: __WEBPACK_IMPORTED_MODULE_15__orders_orders_component__["a" /* FuseEcommerceOrdersComponent */],
        resolve: {
            data: __WEBPACK_IMPORTED_MODULE_16__orders_orders_service__["a" /* EcommerceOrdersService */]
        }
    },
    {
        path: 'orders/:id',
        component: __WEBPACK_IMPORTED_MODULE_17__order_order_component__["a" /* FuseEcommerceOrderComponent */],
        resolve: {
            data: __WEBPACK_IMPORTED_MODULE_18__order_order_service__["a" /* EcommerceOrderService */]
        }
    }
];
var FuseEcommerceModule = /** @class */ (function () {
    ...
    FuseEcommerceModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_9__dashboard_dashboard_component__["a" /* FuseEcommerceDashboardComponent */],
                __WEBPACK_IMPORTED_MODULE_11__products_products_component__["a" /* FuseEcommerceProductsComponent */],
                __WEBPACK_IMPORTED_MODULE_13__product_product_component__["a" /* FuseEcommerceProductComponent */],
                __WEBPACK_IMPORTED_MODULE_15__orders_orders_component__["a" /* FuseEcommerceOrdersComponent */],
                __WEBPACK_IMPORTED_MODULE_17__order_order_component__["a" /* FuseEcommerceOrderComponent */],
                __WEBPACK_IMPORTED_MODULE_19__components_product_prices_product_prices_component__["a" /* ProductPricesComponent */],
                __WEBPACK_IMPORTED_MODULE_20__components_inventory_list_inventory_list_component__["a" /* InventoryListComponent */]
            ],
            imports: [
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_10__dashboard_dashboard_service__["a" /* EcommerceDashboardService */],
                __WEBPACK_IMPORTED_MODULE_12__products_products_service__["a" /* EcommerceProductsService */],
                __WEBPACK_IMPORTED_MODULE_14__product_product_service__["a" /* EcommerceProductService */],
                __WEBPACK_IMPORTED_MODULE_16__orders_orders_service__["a" /* EcommerceOrdersService */],
                __WEBPACK_IMPORTED_MODULE_18__order_order_service__["a" /* EcommerceOrderService */]
            ]
        })
    ], FuseEcommerceModule);
...
/***/ "./src/app/main/content/apps/e-commerce/models.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PriceBreak; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return PriceOption; });
/* unused harmony export InventoryItem */
var formatN = function (n) { return Math.round(n * 100) / 100; };
var PriceBreak = /** @class */ (function () {
    function PriceBreak(prb) {
        if (prb === void 0) { prb = {}; }
        this.qty = prb.qty || 1;
        this.salesPrice = prb.salesPrice || 0;
        this.margin = prb.margin || 0;
        this.unitCost = prb.unitCost || 0;
        this.unitProfit = prb.unitProfit || 0;
    }
    Object.defineProperty(PriceBreak.prototype, "totalSalesPrice", {
        get: function () {
            return formatN(this.salesPrice * this.qty);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PriceBreak.prototype, "totalCost", {
        get: function () {
            return formatN(this.unitCost * this.qty);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PriceBreak.prototype, "totalProfit", {
        get: function () {
            return formatN(this.unitProfit * this.qty);
        },
        enumerable: true,
        configurable: true
    });
    PriceBreak.prototype.updateSalesPrice = function (price) {
        if (this.salesPrice > 0) {
            this.salesPrice = formatN(price);
            this.unitProfit = formatN(this.salesPrice - this.unitCost);
            this.margin = formatN(this.unitProfit * 100 / this.salesPrice);
        }
        else {
            this.salesPrice = formatN(price);
            this.unitProfit = 0;
    ...
    PriceBreak.prototype.updateMargin = function (margin) {
        if (margin < 0 || margin >= 100) {
            return;
        }
        this.margin = formatN(margin);
        this.salesPrice = formatN(this.unitCost * 100 / (100 - this.margin));
        this.unitProfit = formatN(this.salesPrice - this.unitProfit);
    };
    PriceBreak.prototype.updateUnitCost = function (unitCost) {
        if (unitCost < 0 || unitCost >= this.salesPrice) {
            return;
        }
        this.unitCost = formatN(unitCost);
        this.unitProfit = formatN(this.salesPrice - this.unitCost);
        this.margin = formatN(this.unitProfit * 100 / this.salesPrice);
    };
    PriceBreak.prototype.updateProfit = function (profit) {
        if (this.unitProfit < -this.unitCost) {
            return;
        }
        this.unitProfit = formatN(profit);
        this.salesPrice = formatN(this.unitCost + this.unitProfit);
        this.margin = formatN(this.unitProfit * 100 / this.salesPrice);
    };
    return PriceBreak;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__fuse_animations__ = __webpack_require__("./src/@fuse/animations/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__fuse_utils__ = __webpack_require__("./src/@fuse/utils/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__product_model__ = __webpack_require__("./src/app/main/content/apps/e-commerce/product/product.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__product_service__ = __webpack_require__("./src/app/main/content/apps/e-commerce/product/product.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_app_shared_media_dialog_media_dialog_component__ = __webpack_require__("./src/app/shared/media-dialog/media-dialog.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FuseEcommerceProductComponent = /** @class */ (function () {
    function FuseEcommerceProductComponent(productService, formBuilder, snackBar, dialog, location) {
        this.productService = productService;
        this.formBuilder = formBuilder;
        this.snackBar = snackBar;
        this.dialog = dialog;
        this.location = location;
        this.product = new __WEBPACK_IMPORTED_MODULE_12__product_model__["a" /* Product */]();
    }
    FuseEcommerceProductComponent.prototype.ngOnInit = function () {
        ...
        this.onProductChanged =
            this.productService.onProductChanged
                ...
                if (product) {
                    _this.product = new __WEBPACK_IMPORTED_MODULE_12__product_model__["a" /* Product */](product);
                    _this.pageType = 'edit';
                }
                else {
                    _this.pageType = 'new';
                    _this.product = new __WEBPACK_IMPORTED_MODULE_12__product_model__["a" /* Product */]();
                }
                _this.productForm = _this.createProductForm();
            });
        this.onPriceTableChanged =
            this.productService.onPriceTableChanged
                .subscribe(function (table) {
                _this.priceTable = table;
            });
        this.onInventoryChanged =
            this.productService.onInventoryChanged
    ...
    FuseEcommerceProductComponent.prototype.ngOnDestroy = function () {
        ...
        this.onPriceTableChanged.unsubscribe();
        this.onInventoryChanged.unsubscribe();
    };
    FuseEcommerceProductComponent.prototype.createProductForm = function () {
        return this.formBuilder.group({
            id: [this.product.id],
            source: [this.product.source],
            liType: [this.product.liType],
            ...
            lastInsertDate: [this.product.lastInsertData],
    ...
    FuseEcommerceProductComponent.prototype.saveProduct = function () {
        ...
        data.handle = __WEBPACK_IMPORTED_MODULE_11__fuse_utils__["a" /* FuseUtils */].handleize(data.name);
    ...
    FuseEcommerceProductComponent.prototype.openMediaDialog = function () {
        var _this = this;
        this.dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_15_app_shared_media_dialog_media_dialog_component__["a" /* MediaDialogComponent */], {
            panelClass: 'media-dialog',
            data: {
                images: this.product.images.slice()
            }
        });
        this.dialogRef.afterClosed()
            .subscribe(function (selectedImages) {
            if (selectedImages) {
                var newImages = _this.product.images.concat(selectedImages);
                _this.product.images = Object(__WEBPACK_IMPORTED_MODULE_3_lodash__["unionBy"])(_this.product.images, selectedImages, 'url');
            }
        });
    };
    FuseEcommerceProductComponent.prototype.deleteImage = function (img) {
        var idx = this.product.images.indexOf(img);
        if (idx >= 0) {
    ...
    FuseEcommerceProductComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None,
            animations: __WEBPACK_IMPORTED_MODULE_10__fuse_animations__["a" /* fuseAnimations */]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_13__product_service__["a" /* EcommerceProductService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormBuilder */],
            __WEBPACK_IMPORTED_MODULE_2__angular_material__["N" /* MatSnackBar */],
            __WEBPACK_IMPORTED_MODULE_2__angular_material__["n" /* MatDialog */],
            __WEBPACK_IMPORTED_MODULE_14__angular_common__["Location"]])
...
var Product = /** @class */ (function () {
    function Product(product) {
        ...
        this.bin = product.site || '';
        this.lastInsertData = product.lastInsertData || '';
...
var EcommerceProductService = /** @class */ (function () {
    function EcommerceProductService(http) {
        ...
        this.onPriceTableChanged = new __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__["BehaviorSubject"]([]);
    ...
    EcommerceProductService.prototype.getPriceTable = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get('api/e-commerce-prices')
                .subscribe(function (response) {
                _this.priceTable = response;
                _this.onPriceTableChanged.next(response);
                resolve(response);
            }, reject);
        });
    };
    EcommerceProductService.prototype.getInventory = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get('api/e-commerce-inventory')
                .subscribe(function (response) {
                _this.inventory = response;
                _this.onInventoryChanged.next(response);
                resolve(response);
            }, reject);
        });
    };
